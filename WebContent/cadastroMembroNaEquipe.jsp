...
<html lang="en">
  ...
  <body>
    ...
    <div style="margin-bottom: 15%;   padding-left: 2%; padding-right: 2%;">
      ...
      <div class="bodyLogin" >
        <h1 style="color: #FFFFFF; text-align: center; padding-bottom: 3%;" >Adicionar Membro na equipe</h1>

        <form>
          <div class="form-row">

            <div class="form-group col-md-4">
                <label style="color: #FFFFFF; text-align: center;" >Email</label>
                <input type="email" class="form-control" id="inputEmail" name="emailm" placeholder="Email do Usuario">
              </div>
          	</div>
 
         <input class="btn btn-lg btn-primary btn-block" style="margin-left: auto; margin-right: auto; width: 50%; margin-top: 2%;  background-color: #e45c34; color: #FFFFFF; border: none;" type="submit" value="Cadastrar Quadro" id="iCadastrar" formaction="ServletCadastroMembro" formmethod="post" />
